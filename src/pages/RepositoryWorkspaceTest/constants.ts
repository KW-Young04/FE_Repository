export const MAX_CORE_FILE_COUNT = 160;
export const MAX_INITIAL_FILES = MAX_CORE_FILE_COUNT;
export const MAX_PREVIEW_EXPANSION_FILES = 520;
export const MAX_PREVIEW_EXPANSION_BYTES = 28 * 1024 * 1024;
export const MAX_BACKGROUND_PRELOAD_FILES = 360;
export const MAX_BACKGROUND_PRELOAD_BYTES = 18 * 1024 * 1024;
export const MAX_STATIC_SNAPSHOT_PAGES = 5;
