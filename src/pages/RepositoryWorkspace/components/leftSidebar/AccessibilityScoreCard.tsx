...
export default function AccessibilityScoreCard({ score }: AccessibilityScoreCardProps) {
  return (
    <div className="mx-[9px] mt-[10px] mb-[67px] min-h-[172px] rounded-[16px] border border-[#e9e8ee] bg-white px-[15px] pt-[15px] pb-3.5 shadow-[0_1px_2px_rgb(23_23_28/8%)] max-[1360px]:mb-[52px]">
