...
export default function SelectedIssuePanel({ issue }: SelectedIssuePanelProps) {
  return (
    <section className="flex min-h-0 flex-1 flex-col px-3 py-3">
      ...
      {issue ? (
        <article className="scrollbar-subtle mt-3 min-h-0 flex-1 overflow-y-auto border border-slate-200 bg-white p-3">
        ...
        <div className="mt-3 flex flex-1 items-center justify-center border border-dashed border-slate-300 bg-white px-4 py-10 text-center">
